...
all:
	xcodebuild -quiet -jobs $(shell sysctl -n hw.ncpu) -project 'Antoine.xcodeproj' -scheme Antoine -configuration Release -sdk iphoneos -destination 'generic/platform=iOS' -derivedDataPath $(APP_TMP) \
